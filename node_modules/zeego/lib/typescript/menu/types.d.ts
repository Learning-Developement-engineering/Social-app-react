...
import type { ContextMenuView, MenuAuxiliaryPreviewConfig } from 'react-native-ios-context-menu';
import type { ImageOptions, ImageSystemSymbolConfiguration } from 'react-native-ios-context-menu/lib/typescript/types/ImageItemConfig';
import type { SFSymbol } from 'sf-symbols-typescript';
declare type ViewStyle = React.ComponentProps<typeof View>['style'];
declare type TextStyle = React.ComponentProps<typeof Text>['style'];
 ...
 */
export declare type ContextMenuAuxliliaryProps = Omit<MenuAuxiliaryPreviewConfig, 'marginAuxiliaryPreview'> & {
...
export declare type MenuContentProps = {
    children: React.ReactNode;
    style?: ViewStyle;
} & Pick<RadixContentProps, 'loop' | 'side' | 'align' | 'alignOffset' | 'avoidCollisions' | 'collisionPadding' | 'sideOffset'>;
export declare type ContextMenuContentProps = Not<MenuContentProps, 'side' | 'align' | 'sideOffset'>;
...
export declare type MenuItemIconProps = MenuItemCommonProps & {
    /**
...
export declare type MenuItemImageProps = MenuItemCommonProps & {
    /**
...
export declare type MenuArrowProps = {
    height?: number;
    width?: number;
    style?: ViewProps['style'];
    children?: React.ReactNode;
};
export declare type MenuSubTriggerProps = Omit<MenuItemProps, keyof Pick<MenuItemProps, 'onSelect'>> & {
    key: string;
};
export declare type MenuSubProps = {
    children?: React.ReactNode;
};
export declare type MenuSubContentProps = Not<MenuContentProps, 'side' | 'align'>;
export declare type ContextMenuSubContentProps = ContextMenuContentProps & Pick<MenuContentProps, 'sideOffset'>;
...
export declare type MenuCheckboxItemProps = Omit<MenuItemProps, 'onSelect'> & {
    value: 'mixed' | 'on' | 'off' | boolean;
    onValueChange?: (state: 'mixed' | 'on' | 'off', prevState: 'mixed' | 'on' | 'off') => void;
    key: string;
};
export declare type MenuItemIndicatorProps = {
    style?: ViewStyle;
    children?: React.ReactNode;
};
export declare type MenuLabelProps = {
    children: string;
    style?: TextStyle;
};
declare type Not<T extends object, O extends keyof NonNullable<T>> = Omit<T, O>;
export declare type ContextMenuPreviewProps = {
