...
import type { MenuContentProps, MenuGroupProps, MenuItemProps, MenuItemSubtitleProps, MenuItemTitleProps, MenuRootProps, MenuTriggerProps, MenuSeparatorProps, MenuItemIndicatorProps, MenuLabelProps, ContextMenuContentProps, MenuArrowProps, MenuSubContentProps } from '../types';
declare const createAndroidMenu: (Menu: 'ContextMenu' | 'DropdownMenu') => {
