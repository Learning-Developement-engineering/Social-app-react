...
<SubTrigger>
  ...
  const Root = (0, _displayNames.create)(props => {
    var _pickChildren$targetC, _pickChildren$targetC5, _pickChildren$targetC6, _pickChildren$targetC7, _trigger$targetChildr, _pickChildren, _auxiliary$;
...
2. OR, use the textValue prop on <${Menu}.Item textValue="Some value" />`);
    ...
    const mapItemsChildren = children => {
      return _react.Children.map((0, _children.flattenChildren)(children), (_child, index) => {
        ...
        } else if ((0, _children.isInstanceOfComponent)(_child, Group)) {
          const child = _child;
    ...
    const preview = (_pickChildren$targetC7 = (0, _children.pickChildren)(content === null || content === void 0 ? void 0 : content.props.children, Preview).targetChildren) === null || _pickChildren$targetC7 === void 0 ? void 0 : _pickChildren$targetC7[0];
