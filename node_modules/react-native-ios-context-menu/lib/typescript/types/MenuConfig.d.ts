...
export declare type UIMenuOptions = 'destructive' | 'displayInline';
/** Maps to `UIMenuElement.State` */
export declare type MenuState = 'on' | 'off' | 'mixed';
/** Maps to `UIMenuElement.Attributes` */
export declare type MenuAttributes = 'hidden' | 'disabled' | 'destructive' | 'keepsMenuPresented';
/** Maps to `UIMenuElement.Attributes` */
export declare type MenuElementSize = 'small' | 'medium' | 'large';
export declare type DeferredMenuElementConfig = {
    type: 'deferred';
    deferredID: string;
    shouldCache?: boolean;
};
export declare type MenuActionConfig = {
    type?: 'action';
    actionKey: string;
    actionTitle: string;
    /**
...
export declare type MenuElementConfig = MenuConfig | MenuActionConfig | DeferredMenuElementConfig;
