...
var SpecStore = /** @class */ (function () {
    ...
    SpecStore.prototype._process = function (specsJSON) {
        ...
        for (var _f = 0, configArray_1 = configArray; _f < configArray_1.length; _f++) {
            var configJSON = configArray_1[_f];
            try {
        ...
        for (var _g = 0, layersArray_1 = layersArray; _g < layersArray_1.length; _g++) {
            var layerJSON = layersArray_1[_g];
            try {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 6:
                        ...
                        _c = (_b = IDListUtil_1["default"]).updateIdList;
                        _d = [this.store.idLists, name];
