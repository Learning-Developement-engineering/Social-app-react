...
var StatsigContext_1 = __importDefault(require("./utils/StatsigContext"));
...
var StatsigServer = /** @class */ (function () {
    ...
    StatsigServer.prototype.initializeAsync = function () {
        ...
        return this._errorBoundary.capture(function () {
            ...
            _this._pendingInitPromise = null;
            return Promise.resolve();
        }, StatsigContext_1["default"]["new"]({ caller: 'initializeAsync' }));
    };
    // #region Check Gate
    /**
    ...
    StatsigServer.prototype.getFeatureGateSync = function (user, gateName) {
        var _this = this;
        return this._errorBoundary.capture(function (ctx) { return _this.getGateImpl(user, gateName, ExposureLogging.Enabled, ctx); }, function () { return (0, FeatureGate_1.makeEmptyFeatureGate)(gateName); }, StatsigContext_1["default"]["new"]({ caller: 'checkGate', configName: gateName }));
    };
    ...
    StatsigServer.prototype.getFeatureGateWithExposureLoggingDisabledSync = function (user, gateName) {
        var _this = this;
        return this._errorBoundary.capture(function (ctx) { return _this.getGateImpl(user, gateName, ExposureLogging.Disabled, ctx); }, function () { return (0, FeatureGate_1.makeEmptyFeatureGate)(gateName); }, StatsigContext_1["default"]["new"]({
    ...
    StatsigServer.prototype.logGateExposure = function (inputUser, gateName) {
        ...
        }, StatsigContext_1["default"]["new"]({ caller: 'logGateExposure', configName: gateName }));
    };
    //#endregion
    // #region Get Config
    /**
    ...
    StatsigServer.prototype.getConfigSync = function (user, configName) {
        ...
        }, function () { return new DynamicConfig_1["default"](configName); }, StatsigContext_1["default"]["new"]({ caller: 'getConfig', configName: configName }));
    };
    StatsigServer.prototype.getConfigWithExposureLoggingDisabledSync = function (user, configName) {
        ...
        }, function () { return new DynamicConfig_1["default"](configName); }, StatsigContext_1["default"]["new"]({
    ...
    StatsigServer.prototype.getExperimentSync = function (user, experimentName) {
        ...
        }, function () { return new DynamicConfig_1["default"](experimentName); }, StatsigContext_1["default"]["new"]({
    ...
    StatsigServer.prototype.getExperimentLayer = function (experiment) {
        ...
        }, function () { return null; }, StatsigContext_1["default"]["new"]({
    ...
    StatsigServer.prototype.getLayerSync = function (user, layerName) {
        var _this = this;
        return this._errorBoundary.capture(function (ctx) { return _this.getLayerImpl(user, layerName, ExposureLogging.Enabled, ctx); }, function () { return new Layer_1["default"](layerName); }, StatsigContext_1["default"]["new"]({ caller: 'getLayer', configName: layerName }));
    };
    StatsigServer.prototype.getLayerWithExposureLoggingDisabledSync = function (user, layerName) {
        ...
        }, function () { return new Layer_1["default"](layerName); }, StatsigContext_1["default"]["new"]({
    ...
    StatsigServer.prototype.logEvent = function (user, eventName, value, metadata) {
        ...
        }, StatsigContext_1["default"]["new"]({ caller: 'logEvent' }));
    };
    StatsigServer.prototype.logEventObject = function (eventObject) {
        ...
        }, StatsigContext_1["default"]["new"]({ caller: 'logEventObject' }));
    };
    /**
    ...
    StatsigServer.prototype.shutdown = function (timeout) {
        ...
        }, StatsigContext_1["default"]["new"]({ caller: 'shutdown' }));
    };
    /**
     * Informs the statsig SDK that the server is closing or shutting down
     * so the SDK can clean up internal state
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._errorBoundary.capture(function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            }); }, function () { return Promise.resolve(); }, StatsigContext_1["default"]["new"]({ caller: 'shutdownAsync' }))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this._errorBoundary.capture(function () {
                        ...
                        return flushPromise;
                    }, function () { return Promise.resolve(); }, StatsigContext_1["default"]["new"]({ caller: 'flush' }))];
            });
        });
    };
    ...
    StatsigServer.prototype.overrideGate = function (gateName, value, userID) {
        ...
        }, StatsigContext_1["default"]["new"]({ caller: 'overrideGate' }));
    };
    StatsigServer.prototype.overrideConfig = function (configName, value, userID) {
        ...
        }, StatsigContext_1["default"]["new"]({ caller: 'overrideConfig' }));
    };
    StatsigServer.prototype.overrideLayer = function (layerName, value, userID) {
        ...
        }, StatsigContext_1["default"]["new"]({ caller: 'overrideLayer' }));
    };
    ...
    StatsigServer.prototype.getGateImpl = function (inputUser, gateName, exposureLogging, ctx) {
        var _a;
        var _b = this.evalGate(inputUser, gateName, ctx), evaluation = _b.evaluation, user = _b.user;
        if (exposureLogging !== ExposureLogging.Disabled) {
            this.logGateExposureImpl(user, gateName, evaluation, ExposureCause.Automatic);
        }
        return (0, FeatureGate_1.makeFeatureGate)(gateName, evaluation.rule_id, evaluation.value === true, evaluation.group_name, evaluation.id_type, (_a = evaluation.evaluation_details) !== null && _a !== void 0 ? _a : null);
    };
    ...
    StatsigServer.prototype.getConfigImpl = function (inputUser, configName, exposureLogging, ctx) {
        var _a;
        var _b = this.evalConfig(inputUser, configName, ctx), evaluation = _b.evaluation, user = _b.user;
    ...
    StatsigServer.prototype.getLayerImpl = function (inputUser, layerName, exposureLogging, ctx) {
        var _this = this;
        var _a = this.evalLayer(inputUser, layerName, ctx), evaluation = _a.evaluation, user = _a.user;
        ...
        return new Layer_1["default"](layerName, evaluation === null || evaluation === void 0 ? void 0 : evaluation.json_value, evaluation === null || evaluation === void 0 ? void 0 : evaluation.rule_id, evaluation === null || evaluation === void 0 ? void 0 : evaluation.group_name, evaluation === null || evaluation === void 0 ? void 0 : evaluation.config_delegate, exposureLogging === ExposureLogging.Disabled ? null : logFunc, evaluation === null || evaluation === void 0 ? void 0 : evaluation.evaluation_details, evaluation === null || evaluation === void 0 ? void 0 : evaluation.id_type);
    };
