...
var getCompressionFunc_1 = __importDefault(require("./getCompressionFunc"));
...
var StatsigFetcher = /** @class */ (function () {
    ...
    StatsigFetcher.prototype.validateSDKKeyUsed = function (hashedSDKKeyUsed) {
        ...
        if (!matched) {
            this.errorBoundry.logError(new Errors_1.StatsigSDKKeyMismatchError(), StatsigContext_1["default"]["new"]({ caller: 'validateSDKKeyUsed' }));
        }
        return matched;
    };
    ...
    StatsigFetcher.prototype.request = function (method, url, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, retryURL, _c, retries, _d, backoff, _e, isRetrying, signal, _f, compress, markDiagnostic, counter, applyBackoffMultiplier, backoffAdjusted, headers, contents, gzipSync, params, res, error;
            var _this = this;
            return __generator(this, function (_g) {
                _a = options !== null && options !== void 0 ? options : {}, _b = _a.retryURL, retryURL = _b === void 0 ? url : _b, _c = _a.retries, retries = _c === void 0 ? 0 : _c, _d = _a.backoff, backoff = _d === void 0 ? 1000 : _d, _e = _a.isRetrying, isRetrying = _e === void 0 ? false : _e, signal = _a.signal, _f = _a.compress, compress = _f === void 0 ? false : _f;
