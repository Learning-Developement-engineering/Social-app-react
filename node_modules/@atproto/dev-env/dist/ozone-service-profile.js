...
class OzoneServiceProfile {
    constructor(thirdPartyPds) {
        Object.defineProperty(this, "thirdPartyPds", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: thirdPartyPds
        ...
        Object.defineProperty(this, "thirdPartyPdsClient", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "modUserDetails", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {
    ...
    async createDidAndKey() {
        ...
        this.key = await crypto_1.Secp256k1Keypair.create({ exportable: true });
        return { did: this.did, key: this.key };
    }
    async createAppPasswordForVerification(pds) {
    ...
    async createServiceDetails(pds, ozoneUrl, userDetails = {}) {
        ...
        const serviceJwtRes = await this.thirdPartyPdsClient.com.atproto.server.getServiceAuth({
            aud: newServerDid,
        ...
        const getDidCredentials = await pdsClient.com.atproto.identity.getRecommendedDidCredentials();
        ...
        if (!plcOperationData.services)
            plcOperationData.services = {};
        ...
        const plcOp = await this.thirdPartyPdsClient.com.atproto.identity.signPlcOperation(plcOperationData);
        await pdsClient.com.atproto.identity.submitPlcOperation({
            operation: plcOp.data.operation,
        });
        await pdsClient.com.atproto.server.activateAccount();
        await pdsClient.app.bsky.actor.profile.create({ repo: this.did }, {
            displayName: 'Dev-env Moderation',
            description: `The pretend version of mod.bsky.app`,
        });
        await pdsClient.app.bsky.labeler.service.create({ repo: this.did, rkey: 'self' }, {
            policies: {
                labelValues: [
                    '!hide',
                    '!warn',
...
//# sourceMappingURL=ozone-service-profile.js.map