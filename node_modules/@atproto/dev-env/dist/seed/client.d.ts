...
import { AppBskyFeedLike, AppBskyFeedPost, AppBskyGraphBlock, AppBskyGraphFollow, AppBskyGraphList, AppBskyGraphVerification, AppBskyRichtextFacet, AtpAgent, ComAtprotoModerationCreateReport } from '@atproto/api';
...
export declare class SeedClient<Network extends TestNetworkNoAppView = TestNetworkNoAppView> {
    ...
    constructor(network: Network, agent: AtpAgent);
    ...
    createProfile(by: string, displayName: string, description: string, selfLabels?: string[], joinedViaStarterPack?: RecordRef): Promise<{
        displayName: string;
        description: string;
        avatar: {
            cid: string;
    ...
    reply(by: string, root: RecordRef, parent: RecordRef, text: string, facets?: AppBskyRichtextFacet.Main[], images?: ImageRef[]): Promise<{
        text: string;
        ref: RecordRef;
        images: ImageRef[];
    }>;
    repost(by: string, subject: RecordRef): Promise<RecordRef>;
