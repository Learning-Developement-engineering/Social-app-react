...
class ModerationService {
    ...
    async getEvents(opts) {
        const { subject, createdBy, limit, cursor, includeAllUserRecords, sortDirection = 'desc', types, hasComment, comment, createdAfter, createdBefore, addedLabels, removedLabels, addedTags, removedTags, reportTypes, collections, subjectType, policies, } = opts;
    ...
    async report(info) {
        const { reasonType, reason, reportedBy, createdAt = new Date(), subject, } = info;
