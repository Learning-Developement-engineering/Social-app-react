...
export declare const moderationSubjectStatusQueryBuilder: (db: DatabaseSchema) => import("kysely/dist/cjs/parser/select-parser").QueryBuilderWithSelection<{
...
}, "moderation_subject_status" | "account_events_stats" | "account_record_events_stats" | "account_record_status_stats", {
    id: number;
    comment: string | null;
    createdAt: string;
    did: string;
    ...
    record_events_stats: import("../db/schema/record_events_stats").RecordEventsStats;
    verification: import("../db/schema/verification").Verification;
}, "moderation_subject_status" | "account_events_stats" | "account_record_events_stats", "account_record_events_stats.totalReports" | "account_record_events_stats.reportedCount" | "account_record_events_stats.escalatedCount" | "account_record_events_stats.appealedCount">, "account_record_status_stats.subjectCount" | "account_record_status_stats.pendingCount" | "account_record_status_stats.processedCount" | "account_record_status_stats.takendownCount">;
