...
class AppContext {
    ...
    static async fromConfig(cfg, secrets, overrides) {
        ...
        const setService = service_1.SetService.creator();
        const settingService = service_2.SettingService.creator();
        const verificationService = service_3.VerificationService.creator();
