...
export declare const handlerInput: z.ZodObject<{
...
export declare const handlerAuth: z.ZodObject<{
    credentials: z.ZodAny;
    artifacts: z.ZodAny;
}, "strip", z.ZodTypeAny, {
    credentials?: any;
    artifacts?: any;
...
export declare const handlerPipeThroughStream: z.ZodObject<{
    encoding: z.ZodString;
...
export declare const handlerPipeThrough: z.ZodUnion<[z.ZodObject<{
    encoding: z.ZodString;
    buffer: z.ZodType<Buffer<ArrayBuffer>, z.ZodTypeDef, Buffer<ArrayBuffer>>;
    headers: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
}, "strip", z.ZodTypeAny, {
...
export declare const handlerError: z.ZodObject<{
    status: z.ZodNumber;
...
export type RateLimiterReset = (ctx: XRPCReqContext, opts?: {
    calcKey?: CalcKeyFn;
}) => Promise<void>;
