...
const video_1 = require("../../../../lexicon/types/app/bsky/embed/video");
...
const insertFn = async (db, uri, cid, obj, timestamp) => {
    ...
    const facets = (obj.facets || [])
        ...
        .flatMap((feature) => {
        if ((0, facet_1.isMention)(feature)) {
            return {
                type: 'mention',
                value: feature.did,
            };
        }
        if ((0, facet_1.isLink)(feature)) {
            return {
                type: 'link',
                value: feature.uri,
            };
    ...
    for (const postEmbed of postEmbeds) {
        if ((0, images_1.isMain)(postEmbed)) {
        ...
        else if ((0, external_1.isMain)(postEmbed)) {
        ...
        else if ((0, record_1.isMain)(postEmbed)) {
        ...
        else if ((0, video_1.isMain)(postEmbed)) {
...
function separateEmbeds(embed) {
    ...
    if ((0, recordWithMedia_1.isMain)(embed)) {
...
async function getThreadgateRecord(db, postUri) {
    ...
    if (threadgateRecord) {
        return (0, lexicon_1.jsonStringToLex)(threadgateRecord.json);
    }
}
async function validatePostEmbed(db, embedUri, parentUri) {
    ...
    const { embeddingRules: { canEmbed }, } = (0, util_1.parsePostgate)({
        gate: (0, lexicon_1.jsonStringToLex)(postgateRecord.json),
...
async function getReplyRefs(db, reply) {
    ...
    return {
        root: root && {
            ...
            record: (0, lexicon_1.jsonStringToLex)(root.json),
        },
        parent: parent && {
            uri: parent.uri,
            invalidReplyRoot: parent.invalidReplyRoot,
            record: (0, lexicon_1.jsonStringToLex)(parent.json),
        },
        gate: gate && {
            uri: gate.uri,
            record: (0, lexicon_1.jsonStringToLex)(gate.json),
        },
    };
}
