import type { AppState, AsyncStorage, DeviceInfo, ExpoConstants, ExpoDevice, NativeModules, Platform, UUID } from 'statsig-js';
 ...
 * @returns
 */
export default function StatsigProvider({ children, sdkKey, user, setUser, options, waitForCache, waitForInitialization, initializingComponent, mountKey, shutdownOnUnmount, _reactNativeDependencies: rnDeps, }: Props): JSX.Element;
export {};
