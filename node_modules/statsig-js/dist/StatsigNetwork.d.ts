 ...
 */
declare type PromiseWithTimeout<T> = Promise<T> & {
...
export default class StatsigNetwork {
    ...
    sendLogBeacon(payload: Record<string, unknown>): boolean;
    postToEndpoint(endpointName: StatsigEndpoint, body: object, options?: {
        retryOptions?: {
            retryLimit?: number;
            attempt?: number;
            backoff?: number;
