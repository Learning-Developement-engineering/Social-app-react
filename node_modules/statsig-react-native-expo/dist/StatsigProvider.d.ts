 ...
 * @returns
 */
export default function StatsigProvider({ children, sdkKey, user, options, waitForInitialization, reactNativeUUID, initializingComponent, mountKey, shutdownOnUnmount, }: Props): JSX.Element;
export {};
